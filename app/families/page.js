    ...
    return (
        <div className={"w-full mt-2 flex flex-col items-center min-h-screen"}>
            <div className={"flex flex-col justify-start mt-2 font-mono text-md w-[80%] mt-10"}>
                ...
                <div className={"justify-start mt-2 pb-2 font-mono border-b-2"}>
                    ...
                    <p className={"mt-2"}> If would prefer to wait for us to finalize Sponsorship and place orders for all skaters who did not buy their own then please complete this survey: <a className={"text-blue-600 hover:underline hover:text-purple-500"} href={"https://forms.gle/4L493s7RB3kEHcdi8"} target="_blank" rel="noopener noreferrer">
                        Jersey Size Survey
                    </a></p>
                </div>
